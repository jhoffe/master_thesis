...
FORMAT_DICT = {
    ...
    "canary-finetune_SA_ll": "C-1B-FT",
    "canary-finetune_SA_ll_SA": "C-1B-FT+SA",
    "canary-finetune_SA_ll_PS": "C-1B-FT+PS",
    "canary-finetune_SA_ll_SP": "C-1B-FT+SP",
    "canary-finetune_SA_ll_SA_PS": "C-1B-FT+SA+PS",
    "canary-finetune_SA_ll_SA_SP": "C-1B-FT+SA+SP",
    "canary-finetune_SA_ll_PS_SP": "C-1B-FT+PS+SP",
    "canary-finetune_SA_ll_SA_PS_SP": "C-1B-FT+SA+PS+SP",
    "parakeet-finetune_SA_ll": "P-TDT-FT",
    "parakeet-finetune_SA_ll_SA": "P-TDT-FT+SA",
    "parakeet-finetune_SA_ll_PS": "P-TDT-FT+PS",
    "parakeet-finetune_SA_ll_SP": "P-TDT-FT+SP",
    "parakeet-finetune_SA_ll_SA_PS": "P-TDT-FT+SA+PS",
    "parakeet-finetune_SA_ll_SA_SP": "P-TDT-FT+SA+SP",
    "parakeet-finetune_SA_ll_PS_SP": "P-TDT-FT+PS+SP",
    "parakeet-finetune_SA_ll_SA_PS_SP": "P-TDT-FT+SA+PS+SP",
}
