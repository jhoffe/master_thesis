...
if __name__ == "__main__":
    ...
    models = [
        ...
        "parakeet-tdt-0.6b-v3_finetune_pitch-shift",
        "parakeet-tdt-0.6b-v3_finetune_spec-aug_pitch-shift",
        "parakeet-tdt-0.6b-v3_finetune_spec-aug_speed-perturbations",
        #"parakeet-tdt-0.6b-v3_finetune_speed-perturbations_pitch-shift",
        "parakeet-tdt-0.6b-v3_finetune_spec-aug_speed-perturbations_pitch-shift",
        "canary-1b-v2_finetune",
        #"canary-1b-v2_finetune_spec-aug",
        "canary-1b-v2_finetune_pitch-shift",
        #"canary-1b-v2_finetune_speed-perturbations",
        "canary-1b-v2_finetune_spec-aug_pitch-shift",
        "canary-1b-v2_finetune_spec-aug_speed-perturbations",
        #"canary-1b-v2_finetune_pitch-shift_speed-perturbations",
        "canary-1b-v2_finetune_spec-aug_speed-perturbations_pitch-shift",
    ]
